...
export default function Cadastro() {
  ...
  const handlePesquisar = async () => {
    ...
    setLoading(true);
    try {
      const data = await api.post('getPainelData');
  ...
  return (
    <div className="min-h-full bg-[#8B0000] p-4 md:p-8 flex flex-col items-center justify-center overflow-y-auto">
      <div className="w-full max-w-[1800px] space-y-4 relative">
        ...
        <div className="bg-[#E5D1C1] overflow-hidden shadow-xl rounded-lg">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#8B0000] text-white text-xs md:text-sm">
                  ...
                  <tr key={i} className="border-b border-red-900/10 hover:bg-white/20 transition-colors">
                    ...
                    <td className="p-1">
                      ...
                      >
                        ...
                        <option value="SEPARACAO M²">SEPARAÇÃO M²</option> 
                        <option value="SEPARACAO Aviamentos">SEPARAÇÃO Aviamentos</option>                       
                      </select>
                    </td>
                  </tr>
                ))}
        ...
        {pendingItems.length > 0 && (
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-2xl border border-red-900/10 overflow-hidden mt-4">
            <div className="bg-[#8B0000] p-4 text-white flex items-center gap-2">
